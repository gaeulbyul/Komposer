...
;(function(global, factory) {
  ...
  var validCashtag = regexSupplant(
    '(^|#{spaces})(\\$)(#{cashtag})(?=$|\\s|[#{punct}])',
    { cashtag: cashtag, spaces: spaces, punct: punct },
    'gi'
  )
  ...
  var invalidDomainChars = stringSupplant(
  ...
  var validDomainName = regexSupplant(
  ...
  var validSubdomain = regexSupplant(
  ...
  var validGeneralUrlPathChars = regexSupplant(
    /[a-z#{cyrillicLettersAndMarks}0-9!\*';:=\+,\.\$\/%#\[\]\-\u2013_~@\|&#{latinAccentChars}]/i,
    { cyrillicLettersAndMarks: cyrillicLettersAndMarks, latinAccentChars: latinAccentChars }
  )
  ...
  var validUrlBalancedParens = regexSupplant(
    '\\(' +
      '(?:' +
  ...
  var validUrlPathEndingChars = regexSupplant(
  ...
  var validUrlPath = regexSupplant(
    '(?:' +
      '(?:' +
      '#{validGeneralUrlPathChars}*' +
  ...
  var validUrlPrecedingChars = regexSupplant(
  ...
  var validAsciiDomain = regexSupplant(
  ...
  var idna = {
    toAscii: function toAscii(domain) {
      if (
        domain.substring(0, 4) === PUNYCODE_ENCODED_DOMAIN_PREFIX &&
        !domain.match(validAsciiDomain)
      ) {
      ...
      for (var i = 0; i < labels.length; i++) {
        ...
        if (
          punycodeEncodedLabel.length < 1 ||
          punycodeEncodedLabel.length > MAX_DOMAIN_LABEL_LENGTH
        ) {
  ...
  var validTcoUrl = regexSupplant(
    /^https?:\/\/t\.co\/([a-z0-9]+)(?:\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?/,
    { validUrlQueryChars: validUrlQueryChars, validUrlQueryEndingChars: validUrlQueryEndingChars },
    'i'
  )
  ...
  var extractUrlsWithIndices = function extractUrlsWithIndices(text) {
    var options =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_PROTOCOL_OPTIONS
    ...
    var _loop = function _loop() {
      ...
      if (!protocol) {
        if (
          ...
          before.match(invalidUrlWithoutProtocolPrecedingChars)
        ) {
          return 'continue'
        }
  ...
  var hashtagAlpha = regexSupplant(
  ...
  var hashtagAlphaNumeric = regexSupplant(
  ...
  var hashtagBoundary = regexSupplant(
  ...
  var validHashtag = regexSupplant(
  ...
  var validMentionOrList = regexSupplant(
    '(#{validMentionPrecedingChars})' + // $1: Preceding character
    '(#{atSigns})' + // $2: At mark
    '([a-zA-Z0-9_]{1,20})' + // $3: Screen name
      '(/[a-zA-Z][a-zA-Z0-9_-]{0,24})?', // $4: List (optional)
    { validMentionPrecedingChars: validMentionPrecedingChars, atSigns: atSigns },
    'g'
  )
  ...
  var extractMentionsOrListsWithIndices = function(text) {
    ...
    text.replace(validMentionOrList, function(
      match,
      before,
      atSign,
      screenName,
  ...
  var extractEntitiesWithIndices = function(text, options) {
    var entities = extractUrlsWithIndices(text, options)
  ...
  var parseTweet = function parseTweet() {
    ...
    var options =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : configs.defaults
    ...
    var emojiEntitiesMap = emojiParsingEnabled
      ? transformEntitiesToHash(dist_2(normalizedText))
      : []
  ...
  var validateUrlUserinfo = regexSupplant(
    '(?:' +
  ...
  var validateUrlDomain = regexSupplant(
  ...
  var validateUrlIpv4 = regexSupplant(
  ...
  var validateUrlIp = regexSupplant(
    '(?:' + '#{validateUrlIpv4}|' + '#{validateUrlIpv6}' + ')',
    { validateUrlIpv4: validateUrlIpv4, validateUrlIpv6: validateUrlIpv6 },
    'i'
  )
  ...
  var validateUrlHost = regexSupplant(
    '(?:' + '#{validateUrlIp}|' + '#{validateUrlDomain}' + ')',
    { validateUrlIp: validateUrlIp, validateUrlDomain: validateUrlDomain },
    'i'
  )
  ...
  var validateUrlPchar = regexSupplant(
    '(?:' +
      '#{validateUrlUnreserved}|' +
      '#{validateUrlPctEncoded}|' +
      '#{validateUrlSubDelims}|' +
  ...
  var validateUrlUnencoded = regexSupplant(
    '^' + // Full URL
    '(?:' +
    '([^:/?#]+):\\/\\/' + // $1 Scheme
    ')?' +
  ...
  // Unencoded internationalized domains - this doesn't check for invalid UTF-8 sequences
  var validateUrlUnicodeDomain = regexSupplant(
  ...
  var validateUrlUnicodeHost = regexSupplant(
    '(?:' + '#{validateUrlIp}|' + '#{validateUrlUnicodeDomain}' + ')',
    { validateUrlIp: validateUrlIp, validateUrlUnicodeDomain: validateUrlUnicodeDomain },
    'i'
  )
  ...
  var isValidUrl$1 = function(url, unicodeDomains, requireProtocol) {
    ...
    if (
      !(
        (!requireProtocol ||
          (isValidMatch(scheme, validateUrlScheme) && scheme.match(/^https?$/i))) &&
