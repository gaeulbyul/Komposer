// flow-typed signature: c603618b36f84ce41be00f7a17dc710e
// flow-typed version: 64444a2118/twitter-text_v3.x.x/flow_>=v0.104.x
...
declare module 'twitter-text' {
  ...
  |}
  declare type Config = ConfigVersion1 | ConfigVersion2 | ConfigVersion3
  ...
  declare export function extractUrlsWithIndices(
    text: string,
    options?: UrlsWithIndicesOptions
  ): UrlWithIndices[]
  ...
  declare export function hitHighlight(
    text: string,
    hits?: Indices[],
    options?: HitHighlightOptions
  ): string
  declare export function htmlEscape(text: string): string

  declare export function isInvalidTweet(
    text: string,
    options?: Config
  ): 'empty' | 'too_long' | 'invalid_characters' | false
  ...
  declare export function linkToCashtag(
    entity: CashtagWithIndices,
    text: string,
    options?: Options
  ): string
  declare export function linkToHashtag(
    entity: HashtagWithIndices,
    text: string,
    options?: Options
  ): string
  declare export function linkToMentionAndList(
    entity: MentionOrListWithIndices,
    text: string,
    options?: Options
  ): string
  declare export function linkToText(
    entity: EntityWithIndices,
    text: string,
    attributes: Attributes,
    options: Options
  ): string
  declare export function linkToTextWithSymbol(
    entity: EntityWithIndices,
    symbol: string,
    text: string,
    attributes: Attributes,
  ...
  declare export function removeOverlappingEntities(
    entities: EntityWithIndices[]
  ): EntityWithIndices[]
