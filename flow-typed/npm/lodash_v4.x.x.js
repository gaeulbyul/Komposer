// flow-typed signature: 4de2afbbda4f1702a85ca2c81d6db4bc
// flow-typed version: b153d8f500/lodash_v4.x.x/flow_>=v0.153.x
...
declare module 'lodash' {
  ...
  declare type Lodash = {|
    ...
    filter: (<T>(array?: ?$ReadOnlyArray<T>, predicate?: ?Predicate<T>) => Array<T>) &
      (<A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: OPredicate<A, T>) => Array<A>),
    find: (<T>(
      array: $ReadOnlyArray<T>,
      predicate?: ?Predicate<T>,
      fromIndex?: ?number
    ...
    set: ((object: Object, path?: ?Path, value: any) => Object) &
      (<T: void | null>(object: T, path?: ?Path, value?: ?any) => T),
    setWith: (<T>(
      object: T,
      path?: ?Path,
      value: any,
    ...
    transform: ((
      ...
      ((collection: void | null, iteratee?: ?OIteratee<*>, accumulator?: ?any) => { ... }),
    ...
    update: ((object: Object, path: Path, updater: Function) => Object) &
      (<T: void | null>(object: T, path?: ?Path, updater?: ?Function) => T),
    updateWith: ((
      object: Object,
      path?: ?Path,
      updater?: ?Function,
...
declare module 'lodash/fp' {
  ...
  declare type Lodash = {|
    ...
    concat: (<T, U, A: Array<T> | T, B: Array<U> | U>(base: A) => (elements: B) => Array<T | U>) &
      (<T, U, A: Array<T> | T, B: Array<U> | U>(base: A, elements: B) => Array<T | U>),
    ...
    transform: ((
      ...
      ((iteratee: OIteratee<*>, accumulator: any, collection: Object | $ReadOnlyArray<any>) => any),
    unset: ((path: Path) => (object: Object) => Object) & ((path: Path, object: Object) => Object),
    dissoc: ((path: Path) => (object: Object) => Object) & ((path: Path, object: Object) => Object),
